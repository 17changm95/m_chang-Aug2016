public class Magpie4 {
	...
	public String getResponse(String statement) {
		...
		if (findKeyword(statement, "no") >= 0) {
		...
		} else if (findKeyword(statement, "asdfghjkl;") >= 0) {
		...
		} else if (findKeyword(statement, "good, and you") >= 0) {
			response = "Fine, until you came.";
		} else if (findKeyword(statement, "Dreyer") >= 0) {
			response = "She seems like a nice teacher";
		} else if (findKeyword(statement, "Louie") >= 0) {
			response = "Haha.";
		} else if (findKeyword(statement, "9+10") >= 0) {
			response = "21";
		} else if (findKeyword(statement, "Cotter") >= 0) {
			...
			response = "rip";
				...
				|| findKeyword(statement, "Pikachu") >= 0) {
			response = "Pikachu welcomes you to the world of Pokemon!!!\n\t\t(\\__/)\n\t\t(o^.^)\n\t       z(____)";
		} else if (findKeyword(statement, "dank") >= 0 
				|| findKeyword(statement, "memes") >= 0) {
		...
		if (psn >= 0 && findKeyword(statement, "I", psn) >= 0) {
	 ...
	 * 
	 * @param statement
	 *            the user statement, assumed to contain  followed by "me"
	 * @return the transformed statement
	 */
	private String transformISomethingYouStatement(String statement) {
		...
		int psnOfYou = findKeyword(statement, "you", psnOfYou + 3);
		String restOfStatement = statement.substring(psnOfYou + 3, psnOfI).trim();
