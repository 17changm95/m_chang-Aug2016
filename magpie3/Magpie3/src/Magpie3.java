public class Magpie3 {
	...
	public String getResponse(String statement) {
		...
		} else if (findKeyword(statement, "Bob") != -1) {
			response = "Bob makes me feel good. :)";
		} else if (findKeyword(statement, "asdfghjkl;") != -1) {
			response = "Talk to me in real English you illiterate Missourian.";
		} else if (findKeyword(statement, "Hi ") != -1
				|| findKeyword(statement, "hi ") != -1
				|| findKeyword(statement, "hello") != -1
				|| findKeyword(statement, "Hello") >= 0) {
			response = "How are you?";
		} else if (findKeyword(statement, "good, and you") != -1) {
			response = "Fine, until you came.";
		} else if (findKeyword(statement, "Dreyer") != -1) {
			response = "She seems like a nice teacher";
		} else if (findKeyword(statement, "Louie") != -1) {
			response = "Haha.";
		} else if (findKeyword(statement, "9+10") != -1) {
			response = "21";
		} else if (findKeyword(statement, "Cotter") != -1) {
			response = "I'm triggered.";
		} else if (findKeyword(statement, "harambe") != -1
				|| findKeyword(statement, "Harambe") >=0) {
			response = "rip";
		} else if (findKeyword(statement, "pikachu") != -1
				|| findKeyword(statement, "Pikachu") != -1) {
			response = "Pikachu welcomes you to the world of Pokemon!!!\n\t\t(\\__/)\n\t\t(o^.^)\n\t       z(____)";
		} else if (findKeyword(statement, "dank") != -1 
				|| findKeyword(statement, "memes") != -1) {
